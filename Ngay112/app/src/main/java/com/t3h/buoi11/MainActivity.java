...
//        Intent intent = DetailActivity.newInstance(this, data.get(position));
//        startActivityForResult(intent, REQUEST_DETAIL);

        Intent intent = new Intent(this, DetailActivity.class);
        String tieude = data.get(position).getName();
        String tacgia = data.get(position).getTacgia();
        String chuong = data.get(position).getSubject();
        String date = data.get(position).getDate();
        String detail = data.get(position).getNoidung();
